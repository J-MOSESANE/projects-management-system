        ...
        >
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "Completed Projects")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
            ...
            >
              ...
              <Text
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="M-Pesa Card to Wallet BRS"
                {...getOverrideProps(overrides, "M-Pesa Card to Wallet BRS")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              <View
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Icon35492693")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vector35492694")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="TikTok Bundles"
                {...getOverrideProps(overrides, "TikTok Bundles")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 32435492696")}
            >
              <View
                width="24px"
                height="24px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Icon35492697")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vector35492698")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="Morning Offfers"
                {...getOverrideProps(overrides, "Morning Offfers")}
              ></Text>
            </Flex>
          </Flex>
          <Text
            ...
            {...getOverrideProps(overrides, "Pending Projects")}
          ></Text>
          <Flex
            gap="16px"
            direction="column"
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 32429767107")}
            >
              <View
                width="24px"
                height="24px"
              ...
              <Text
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="NXT LVL_New Bundles"
                {...getOverrideProps(overrides, "NXT LVL_New Bundles")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              ...
              <Text
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="All Net Voice"
                {...getOverrideProps(overrides, "All Net Voice")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              ...
              >
                <Text
                  ...
                  padding="0px 0px 0px 0px"
                  whiteSpace="pre-wrap"
                  children="Karabelo Bookholane"
                  {...getOverrideProps(overrides, "Karabelo Bookholane")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  {...getOverrideProps(overrides, "Product Owner")}
                ></Text>
              </Flex>
            </Flex>
            <View
